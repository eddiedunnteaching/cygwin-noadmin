...
setup-x86_64.exe --no-desktop --no-startmenu --no-replaceonreboot  --no-admin --site https://mirrors.rit.edu/cygwin/ --root cygwin64 --packages "git,lynx,ansible,ansible-doc"  --quiet-mode
